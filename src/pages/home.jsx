...
export default function Home() {
  ...
  return (
    <>
      ...
      <p className="hint-text">Click my name 🤫</p>
      ...
      <div className="instructions">
        <h2>About me</h2>
        <ul>
          <li>Hi! My name is Ivan Xiong. I am a Junior studying Computer Science and Math at NYU.</li>
          <li>I am a passionate software developer with interests in big tech, big data, investment, and finance.</li>
